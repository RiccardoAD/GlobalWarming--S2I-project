...
export const Ocean = () => {
  ...
  return (
    <div className="md:h-[calc(100vh-56px-2rem)] flex flex-col items-center bg-sky-100 dark:bg-[#5b7a92] rounded p-6 ml-2 mr-2 md:mr-4 shadow-md dark:shadow-slate-900 text-sm md:text-base">
      <h1 className="text-4xl md:text-5xl font-bold mb-5 text-blue-900 dark:text-[#c0d6e4]">Riscaldamento degli Oceani</h1>
      <ul className="prose max-w-screen-lg">
        <p>
          Gli oceani regolano la temperatura terrestre assorbendo gran parte del calore in eccesso prodotto dalle attività umane. Tuttavia, con l{"'"} aumento delle emissioni, gli oceani stanno diventando sempre più caldi, riducendo la loro capacità di assorbire calore. Senza questo effetto regolatore, la temperatura media globale sarebbe intorno ai 50 gradi Celsius invece di 15.
        </p>
