...
export const Co2 = () => {
  ...
  return (
    <div className="md:h-[calc(100vh-56px-2rem)] flex flex-col items-center bg-sky-100 dark:bg-[#5b7a92] rounded p-6 ml-2 mr-2 md:mr-4 shadow-md dark:shadow-slate-900 text-sm md:text-base">
      <h1 className="text-4xl md:text-5xl font-bold mb-5 text-blue-900 dark:text-[#c0d6e4] "> {t("co2.title")} </h1>
      <ul className="prose prose-lg max-w-screen-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mt-5">
          ...
          <Solutions /> */}
          <Section
  title={t("co2.impactsTitle")}
  items={t("co2.impacts", { returnObjects: true })}
  icons={[faExclamationTriangle, faWater, faWind, faLeaf]}
/>
<Section
  title={t("co2.solutionsTitle")}
  items={t("co2.solutions", { returnObjects: true })}
  icons={[faWind, faLeaf, faFlask, faHandsHelping]}
/>
